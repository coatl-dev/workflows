...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/pre-commit.yml@v1.2.1
    with:
      python-version: "3.11"
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/pypi-upload.yml@v1.2.1
    with:
      image: ubuntu-22.04
      python-version: "3.10"
    secrets:
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/tox-envs.yml@v1.2.1
    with:
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/tox-gh.yml@v1.2.1
    with:
      python-versions: '["3.7", "3.8", "3.9", "3.10"]'
```
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/tox.yml@v1.2.1
    with:
      image: ubuntu-20.04
      pre-commit: true
```
