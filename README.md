...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/docker-build-push-multi-platform.yml@v7.0.24
    with:
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/docker-build-push-multi-registry.yml@v7.0.24
    with:
...
jobs:
  pip-compile-upgrade:
    uses: coatl-dev/workflows/.github/workflows/pip-compile-upgrade.yml@v7.0.24
    with:
...
jobs:
  pre-commit-autoupdate:
    uses: coatl-dev/workflows/.github/workflows/pre-commit-autoupdate.yml@v7.0.24
    with:
      skip-repos: 'flake8'
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/pre-commit.yml@v7.0.24
    with:
      skip-hooks: 'pylint'
```
...
jobs:
  prek-autoupdate:
    uses: coatl-dev/workflows/.github/workflows/prek-autoupdate.yml@v7.0.24
    with:
      autoupdate-branch: 'develop'
    secrets:
      gh-token: ${{ secrets.PERSONAL_ACCESS_TOKEN }}
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/prek.yml@v7.0.24
```
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/pylint.yml@v7.0.24
    with:
      path: src
```
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/pypi-upload.yml@v7.0.24
    with:
      python-version: '3.12'
    secrets:
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/tox-docker.yml@v7.0.24
```
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/tox-gh.yml@v7.0.24
    with:
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/tox.yml@v7.0.24
    with:
      python-versions: |
        3.9
        3.10
...
jobs:
  pip-compile-upgrade:
    uses: coatl-dev/workflows/.github/workflows/uv-pip-compile-upgrade.yml@v7.0.24
    with:
      path: requirements.txt
    secrets:
      gh-token: ${{ secrets.PERSONAL_ACCESS_TOKEN }}
