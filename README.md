...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/black.yml@v1.1.2
    with:
      sources-root: 'src'
```
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/flake8.yml@v1.1.2
    with:
      sources-root: 'src'
```
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/mypy.yml@v1.1.2
    with:
