...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/black.yml@v0.0.1
    with:
      sources-root: 'src'
```
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/flake8.yml@v0.0.1
    with:
      sources-root: 'src'
```
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/mypy.yml@v0.0.1
    with:
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/pre-commit.yml@v0.0.1
    with:
      skip-hooks: 'pylint'
```
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/pylint.yml@v0.0.1
```
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/pypi-upload.yml@v0.0.1
    with:
      python-version: '3.11'
    secrets:
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/tox-docker.yml@v0.0.1
```
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/tox-envs.yml@v0.0.1
    with:
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/tox-gh.yml@v0.0.1
    with:
      python-versions: '["3.7", "3.8", "3.9", "3.10", "3.11", "3.12"]'
```
...
jobs:
  main:
    uses: coatl-dev/workflows/.github/workflows/tox.yml@v0.0.1
```
